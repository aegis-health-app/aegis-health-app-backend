...
import { ApiBadRequestResponse, ApiBearerAuth, ApiBody, ApiCreatedResponse, ApiForbiddenResponse, ApiNotAcceptableResponse, ApiNotFoundResponse, ApiOkResponse, ApiOperation, ApiTags, ApiUnauthorizedResponse, ApiMethodNotAllowedResponse } from '@nestjs/swagger';
import { ElderlyGuard, CaretakerGuard } from 'src/auth/jwt.guard';
import { UserService } from 'src/user/user.service';
import { AllQuestionsCaretakerDto, 
  CreateQuestionDto, 
  DeleteQuestionDto, 
  EditQuestionDto, 
  ...
  GetHistoryDto, 
  GetHistoryByTimestampDto } from './dto/memoryPractice.dto';
